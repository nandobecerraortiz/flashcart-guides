...
1. Change into the `flashcart-guides` directory (`cd flashcart-guides`), then run `mkdocs serve` or `python -m mkdocs serve` to build and serve the site locally at `localhost:8000`.
